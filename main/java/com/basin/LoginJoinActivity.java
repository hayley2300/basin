...
public class LoginJoinActivity extends AppCompatActivity {
    ...
    EditText login_join_id;
    EditText login_join_pw ;
    EditText login_join_pw_re ;
    EditText login_join_email1;
    EditText login_join_email2 ;
    Button login_join_sendmail;
    EditText login_join_4digit;
    TextView login_join_confirmbtn;
    TextView login_join_cancelbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        login_join_id = findViewById(R.id.login_join_id);
        login_join_pw = findViewById(R.id.login_join_pw);
        login_join_pw_re = findViewById(R.id.login_join_pw_re);
        login_join_email1 = findViewById(R.id.login_join_email1);
        login_join_email2 = findViewById(R.id.login_join_email2);
        login_join_sendmail = findViewById(R.id.login_join_sendmail);
        login_join_4digit = findViewById(R.id.login_join_4digit);
        login_join_confirmbtn = findViewById(R.id.login_join_confirmbtn);
        login_join_cancelbtn = findViewById(R.id.login_join_cancelbtn);
        ...
        login_join_confirmbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(login_join_id.getText().toString().trim().equals("")||login_join_id.getText().toString().trim().equals("")){
                    ...
                    LoginJoinActivity.NetworkTask networkTask = new LoginJoinActivity.NetworkTask("http://hayley2300.cafe24.com/memJoinJson/", addRowValue);
                    networkTask.execute();
                }
        ...
        login_join_cancelbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((LoginJoinActivity) mContext).finish();
            }
        });
